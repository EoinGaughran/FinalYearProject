...
public class AwsListActivity extends ListActivity {
    ...
    private void initData() {
        ...
        s3 = Util.getS3Client(AwsListActivity.this);
    ...
    private class GetFileListTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            dialog = ProgressDialog.show(AwsListActivity.this,
        ...
        protected Void doInBackground(Void... inputs) {
            ...
            s3ObjList = s3.listObjects(com.example.pcworld.appuserui.Constants.BUCKET_NAME).getObjectSummaries();
